...
public final class Iterators {
    ...
    public static final class MergingIterator<T> extends UnmodifiableIterator<T> {
        ...
        public static class IndexedIterator<E> {
            ...
            public IndexedIterator(PeekingIterator<E> peekingIterator, int i) {
        ...
        public MergingIterator(Iterable<? extends Iterator<? extends T>> iterable, final Comparator<? super T> comparator) {
            this.queue = new PriorityQueue(2, new Comparator() { // from class: com.google.common.collect.p
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return Iterators.MergingIterator.lambda$new$0(comparator, (Iterators.MergingIterator.IndexedIterator) obj, (Iterators.MergingIterator.IndexedIterator) obj2);
                }
            });
            int i = 0;
            for (Iterator<? extends T> it : iterable) {
                if (it.hasNext()) {
                    this.queue.add(new IndexedIterator<>(Iterators.peekingIterator(it), i));
                    i++;
                }
            }
        }
        ...
        public static /* synthetic */ int lambda$new$0(Comparator comparator, IndexedIterator indexedIterator, IndexedIterator indexedIterator2) {
            return ComparisonChain.start().compare(indexedIterator.iterator.peek(), indexedIterator2.iterator.peek(), comparator).compare(indexedIterator.index, indexedIterator2.index).result();
        }
        ...
        @ParametricNullness
        public T next() {
            IndexedIterator<T> indexedIteratorRemove = this.queue.remove();
            PeekingIterator<T> peekingIterator = indexedIteratorRemove.iterator;
            T next = peekingIterator.next();
            if (peekingIterator.hasNext()) {
                this.queue.add(indexedIteratorRemove);
            }
            return next;
        }
    }
    ...
    public static void checkNonnegative(int i) {
        if (i < 0) {
            throw new IndexOutOfBoundsException(AbstractC2039eV.i(i, "position (", ") must not be negative"));
        }
    }
    ...
    public static <T> T get(Iterator<T> it, int i) {
        ...
        throw new IndexOutOfBoundsException(AbstractC2039eV.h(i, "position (", iAdvance, ") must be less than the number of elements that remained (", ")"));
    }
