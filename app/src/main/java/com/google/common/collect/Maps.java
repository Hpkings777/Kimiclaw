...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(Object obj, @ParametricNullness V v) {
    ...
    public static abstract class EntrySet<K, V> extends Sets.ImprovedAbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                if (Objects.equals(objSafeGet, entry.getValue()) && (objSafeGet != null || map().containsKey(key))) {
                    return true;
                }
            }
            return false;
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        private static <K, V> Predicate<Map.Entry<V, K>> inversePredicate(Predicate<? super Map.Entry<K, V>> predicate) {
            return new o(predicate, 1);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ boolean lambda$inversePredicate$0(Predicate predicate, Map.Entry entry) {
    ...
    public static final class FilteredMapValues<K, V> extends Values<K, V> {
        ...
        public boolean remove(Object obj) {
            ...
            while (it.hasNext()) {
                Map.Entry<K, V> next = it.next();
                if (this.predicate.apply(next) && Objects.equals(next.getValue(), obj)) {
                    it.remove();
                    return true;
                }
            }
    ...
    public static final class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof MapDifference.ValueDifference) {
                ...
                if (Objects.equals(this.left, valueDifference.leftValue()) && Objects.equals(this.right, valueDifference.rightValue())) {
                    return true;
                }
            }
            return false;
    ...
    public static <K, V1, V2> Function<Map.Entry<K, V1>, Map.Entry<K, V2>> asEntryToEntryFunction(EntryTransformer<? super K, ? super V1, V2> entryTransformer) {
        ...
        return new C4344v0(entryTransformer, 3);
    }
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                A20 a20 = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
                if (equivalence.equivalent(value, a20)) {
                    map5.put(key, value);
                } else {
                    map6.put(key, ValueDifferenceImpl.create(value, a20));
                }
            } else {
                map3.put(key, value);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Object lambda$transformValues$0(Function function, Object obj, Object obj2) {
        return function.apply(obj2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Object lambda$transformValues$1(Function function, Object obj, Object obj2) {
        return function.apply(obj2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Object lambda$transformValues$2(Function function, Object obj, Object obj2) {
        return function.apply(obj2);
    }
    ...
    public static <K, V1, V2> Map<K, V2> transformValues(Map<K, V1> map, Function<? super V1, V2> function) {
        ...
        return transformEntries(map, new E90(function, 2));
    }
    ...
    public static <K, V1, V2> SortedMap<K, V2> transformValues(SortedMap<K, V1> sortedMap, Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
        return transformEntries((SortedMap) sortedMap, (EntryTransformer) new E90(function, 0));
    }
    ...
    public static <K, V1, V2> NavigableMap<K, V2> transformValues(NavigableMap<K, V1> navigableMap, Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
        return transformEntries((NavigableMap) navigableMap, (EntryTransformer) new E90(function, 1));
    }
