...
public final class Encoder {
    ...
    private static GenericGF getGF(int i) {
        ...
        throw new IllegalArgumentException(YI0.h(i, "Unsupported word size "));
    }
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2, Charset charset) {
        ...
        if (i2 != 0) {
            ...
            if (iAbs <= (z2 ? 4 : 32)) {
                ...
                throw new IllegalArgumentException(AbstractC2039eV.i(i2, "Illegal value ", " for layers"));
            }
        } else {
            ...
            while (i10 <= 32) {
                ...
                if (size2 <= i13) {
                    ...
                    int i15 = i13 - (i13 % i11);
                    if ((z3 == 0 || bitArrayStuffBits2.getSize() <= i11 * 64) && bitArrayStuffBits2.getSize() + size <= i15) {
