...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public HashCode hashBytes(byte[] bArr, int i, int i2) {
        ...
        int i6 = 0;
        while (i5 < i2) {
            unsignedInt ^= Byte.toUnsignedInt(bArr[i + i5]) << i6;
            i5++;
            i6 += 8;
        }
        return fmix(mixK1(unsignedInt) ^ iMixH1, i2);
    }
    ...
    public String toString() {
        return AbstractC4671xI0.n(new StringBuilder("Hashing.murmur3_32("), this.seed, ")");
    }
}
