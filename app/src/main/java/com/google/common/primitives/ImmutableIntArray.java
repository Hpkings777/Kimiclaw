...
public final class ImmutableIntArray implements Serializable {
    ...
    public static final class AsList extends AbstractList<Integer> implements RandomAccess, Serializable {
    ...
    public int hashCode() {
        int iHashCode = 1;
        for (int i = this.start; i < this.end; i++) {
            iHashCode = (iHashCode * 31) + Integer.hashCode(this.array[i]);
        }
        return iHashCode;
    }
    ...
    public static final class Builder {
        ...
        public Builder addAll(IntStream intStream) {
            ...
            Spliterator.forEachRemaining(new HI(this, 1));
            return this;
        }
