...
public final class UnsignedLongs {
    ...
    public static final class ParseOverflowDetection {
        ...
        static {
            ...
            for (int i = 2; i <= 36; i++) {
                ...
                maxSafeDigits[i] = bigIntegerShiftLeft.toString(i).length() - 1;
            }
        }
    ...
    public static long decode(String str) {
        ...
        try {
            ...
            NumberFormatException numberFormatException = new NumberFormatException(AbstractC4671xI0.y("Error parsing value: ", str));
    ...
    public static long parseUnsignedLong(String str, int i) {
        ...
        if (i < 2 || i > 36) {
            throw new NumberFormatException(YI0.h(i, "illegal radix: "));
        }
