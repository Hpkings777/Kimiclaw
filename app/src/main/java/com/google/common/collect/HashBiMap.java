    ...
    public final class EntryForKey extends AbstractMapEntry<K, V> {
        ...
        public void updateIndex() {
            ...
            if (i != -1) {
                ...
                if (i <= hashBiMap.size && Objects.equals(hashBiMap.keys[i], this.key)) {
                    return;
                }
            }
    ...
    public static final class EntryForValue<K, V> extends AbstractMapEntry<V, K> {
        ...
        private void updateIndex() {
            ...
            if (i != -1) {
                ...
                if (i <= hashBiMap.size && Objects.equals(this.value, hashBiMap.values[i])) {
                    return;
                }
            }
    ...
    public final class EntrySet extends View<K, V, Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                if (iFindEntryByKey != -1 && Objects.equals(value, HashBiMap.this.values[iFindEntryByKey])) {
                    return true;
                }
            }
            return false;
    ...
    public static final class InverseEntrySet<K, V> extends View<K, V, Map.Entry<V, K>> {
        ...
        public boolean contains(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                if (iFindEntryByValue != -1 && Objects.equals(this.biMap.keys[iFindEntryByValue], value)) {
                    return true;
                }
            }
            return false;
