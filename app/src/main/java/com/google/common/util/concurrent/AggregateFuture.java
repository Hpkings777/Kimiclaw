...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    public void lambda$init$0(int i, ListenableFuture<? extends InputT> listenableFuture) {
        try {
    ...
    public final void init() {
        ...
        if (this.allMustSucceed) {
            ...
            while (it.hasNext()) {
                ...
                int i2 = i + 1;
                if (next.isDone()) {
                    lambda$init$0(i, next);
                } else {
                    next.addListener(new f(this, i, next), MoreExecutors.directExecutor());
                }
                i = i2;
            }
            return;
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.g
            ...
            public final void run() {
                this.a.lambda$init$1(immutableCollection2);
            }
        };
        ...
        while (it2.hasNext()) {
            ...
            if (next2.isDone()) {
                lambda$init$1(immutableCollection2);
            } else {
