...
public final class Multimaps {
    ...
    public static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public final class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                ...
                Multimap multimap = AsMap.this.multimap;
                Objects.requireNonNull(multimap);
                return Maps.asMapEntryIterator(setKeySet, new C4344v0(multimap, 4));
            }
    ...
    public static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        public List<V2> transform(@ParametricNullness K k, Collection<V1> collection) {
            return Lists.transform((List) collection, new q(this, k, 0));
        }
    }
    ...
    public static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer() { // from class: com.google.common.collect.r
                @Override // com.google.common.collect.Maps.EntryTransformer
                public final Object transformEntry(Object obj, Object obj2) {
                    return this.a.transform(obj, (Collection) obj2);
                }
            });
        }
        ...
        public Collection<V2> createValues() {
            return Collections2.transform(this.fromMultimap.entries(), new u(this, 2));
        }
        ...
        public Collection<V2> transform(@ParametricNullness K k, Collection<V1> collection) {
            q qVar = new q(this, k, 1);
            return collection instanceof List ? Lists.transform((List) collection, qVar) : Collections2.transform(collection, qVar);
        }
    ...
    public static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> mapUnmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new s(0)));
    ...
    public static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> flatteningToMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends Stream<? extends V>> function2, java.util.function.Supplier<M> supplier) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Object lambda$transformValues$0(com.google.common.base.Function function, Object obj, Object obj2) {
        return function.apply(obj2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ Object lambda$transformValues$1(com.google.common.base.Function function, Object obj, Object obj2) {
        return function.apply(obj2);
    }
    ...
    @IgnoreJRERequirement
    public static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> toMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, java.util.function.Supplier<M> supplier) {
    ...
    public static <K, V1, V2> Multimap<K, V2> transformValues(Multimap<K, V1> multimap, com.google.common.base.Function<? super V1, V2> function) {
        ...
        return transformEntries(multimap, new E90(function, 4));
    }
    ...
    public static <K, V1, V2> ListMultimap<K, V2> transformValues(ListMultimap<K, V1> listMultimap, com.google.common.base.Function<? super V1, V2> function) {
        Preconditions.checkNotNull(function);
        return transformEntries((ListMultimap) listMultimap, (Maps.EntryTransformer) new E90(function, 3));
    }
