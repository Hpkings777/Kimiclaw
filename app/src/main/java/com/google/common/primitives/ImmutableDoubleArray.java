...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static final class AsList extends AbstractList<Double> implements RandomAccess, Serializable {
    ...
    public int hashCode() {
        int iHashCode = 1;
        for (int i = this.start; i < this.end; i++) {
            iHashCode = (iHashCode * 31) + Double.hashCode(this.array[i]);
        }
        return iHashCode;
    }
    ...
    public static final class Builder {
        ...
        private static int expandedCapacity(int i, int i2) {
            ...
            return iHighestOneBit < 0 ? IntCompanionObject.MAX_VALUE : iHighestOneBit;
        }
        ...
        /* JADX WARN: Type inference failed for: r5v1, types: [java.util.Spliterator, java.util.Spliterator$OfDouble] */
        @IgnoreJRERequirement
        public Builder addAll(DoubleStream doubleStream) {
            ...
            Spliterator.forEachRemaining(new DoubleConsumer() { // from class: rW
