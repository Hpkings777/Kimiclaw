...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    public void removeNode(Node<K, V> node) {
        ...
        if (node.previousSibling == null && node.nextSibling == null) {
            KeyList<K, V> keyListRemove = this.keyToKeyList.remove(node.getKey());
            Objects.requireNonNull(keyListRemove);
            keyListRemove.count = 0;
            this.modCount++;
        } else {
            KeyList<K, V> keyList = this.keyToKeyList.get(node.getKey());
        ...
        return new AbstractSequentialList<V>() { // from class: com.google.common.collect.LinkedListMultimap.1ValuesImpl
            ...
            public ListIterator<V> listIterator(int i) {
                ...
                return new TransformedListIterator<Map.Entry<K, V>, V>(this, nodeIterator) { // from class: com.google.common.collect.LinkedListMultimap.1ValuesImpl.1
                    final /* synthetic */ C1ValuesImpl this$1;
