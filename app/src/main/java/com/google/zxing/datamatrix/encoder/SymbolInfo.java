...
public class SymbolInfo {
    ...
    public final int getSymbolHeight() {
        return (getVerticalDataRegions() * 2) + getSymbolDataHeight();
    }

    public final int getSymbolWidth() {
        return (getHorizontalDataRegions() * 2) + getSymbolDataWidth();
    }
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2, boolean z) {
        ...
        if (z) {
            throw new IllegalArgumentException(YI0.h(i, "Can't find a symbol arrangement that matches the message. Data codewords: "));
        }
        return null;
    }
}
