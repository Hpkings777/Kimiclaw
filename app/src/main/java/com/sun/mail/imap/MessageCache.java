...
public class MessageCache {
        ...
        if (iMAPMessageArr == null) {
            ...
            if (iArr != null) {
                ...
                if (this.logger.isLoggable(Level.FINE)) {
                    ...
                    StringBuilder sbR = AbstractC2039eV.r(i, "message ", " has sequence number ");
                    sbR.append(this.seqnums[i - 1]);
    ...
    public IMAPMessage getMessage(int i) {
        if (i < 1 || i > this.size) {
            throw new ArrayIndexOutOfBoundsException(AbstractC4671xI0.n(AbstractC2039eV.r(i, "message number (", ") out of bounds ("), this.size, ")"));
        }
        int i2 = i - 1;
    ...
    public int seqnumOf(int i) {
        ...
        if (this.logger.isLoggable(Level.FINE)) {
            MailLogger mailLogger = this.logger;
            StringBuilder sbR = AbstractC2039eV.r(i, "msgnum ", " is seqnum ");
            sbR.append(this.seqnums[i - 1]);
            mailLogger.fine(sbR.toString());
        }
