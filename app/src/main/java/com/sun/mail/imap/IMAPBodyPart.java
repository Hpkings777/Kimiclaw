...
public class IMAPBodyPart extends MimeBodyPart implements ReadableMime {
            ...
            synchronized (this.message.getMessageCacheLock()) {
                try {
                    ...
                    if (protocol.isREV1()) {
                        ...
                        this.headers.addHeader(HttpHeaders.CONTENT_TYPE, this.type);
        ...
        try {
            if (this.dh == null) {
                if (this.bs.isMulti()) {
                    ...
                    this.dh = new DataHandler(new IMAPNestedMessage(iMAPMessage, bodystructure.bodies[0], bodystructure.envelope, this.sectionId), this.type);
                }
            }
        } catch (Throwable th) {
            throw th;
    ...
    public String getFileName() throws MessagingException {
        ...
        if ((str == null || str.isEmpty()) && (parameterList = this.bs.cParams) != null) {
