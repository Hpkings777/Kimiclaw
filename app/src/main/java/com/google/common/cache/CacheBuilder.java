...
public final class CacheBuilder<K, V> {
    ...
    public String toString() {
        ...
        if (this.expireAfterWriteNanos != -1) {
            stringHelper.add("expireAfterWrite", AbstractC2039eV.l(this.expireAfterWriteNanos, "ns", new StringBuilder()));
        }
        if (this.expireAfterAccessNanos != -1) {
            stringHelper.add("expireAfterAccess", AbstractC2039eV.l(this.expireAfterAccessNanos, "ns", new StringBuilder()));
        }
