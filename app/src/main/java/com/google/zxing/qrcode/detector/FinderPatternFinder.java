    ...
    private FinderPattern[] selectBestPatterns() throws NotFoundException {
        ...
        while (i2 < this.possibleCenters.size() - i) {
            ...
            while (i3 < this.possibleCenters.size() - 1) {
                ...
                i3++;
                int i4 = i;
                for (int i5 = i3; i5 < this.possibleCenters.size(); i5++) {
                    FinderPattern finderPattern3 = this.possibleCenters.get(i5);
                    if (finderPattern3.getEstimatedModuleSize() <= 1.4f * estimatedModuleSize) {
                        ...
                        if (dSquaredDistance < dSquaredDistance2) {
                            if (dSquaredDistance2 <= dSquaredDistance3) {
                                ...
                                dAbs = Math.abs(dSquaredDistance2 - (d * 2.0d)) + Math.abs(dSquaredDistance2 - (dSquaredDistance3 * 2.0d));
                                if (dAbs >= d2) {
                                    finderPatternArr[0] = finderPattern;
                                    finderPatternArr[1] = finderPattern2;
                                    finderPatternArr[i4] = finderPattern3;
                                    d2 = dAbs;
                                }
                            }
                            d = dSquaredDistance;
