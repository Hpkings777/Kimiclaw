...
public class IMAPProtocol extends Protocol {
    ...
    private static final byte[] DONE = {68, 79, 78, 69, Ascii.CR, 10};
    ...
    public IMAPProtocol(String str, String str2, int i, Properties properties, boolean z, MailLogger mailLogger) throws ProtocolException, IOException {
        super(str2, i, properties, AbstractC4671xI0.y("mail.", str), z, mailLogger);
    ...
    public ListInfo[] doList(String str, String str2, String str3) throws ProtocolException {
        Argument argument = new Argument();
    ...
    public RFC822DATA fetchRFC822(int i, String str) throws ProtocolException {
        Response[] responseArrFetch = fetch(i, str == null ? "RFC822" : "RFC822.".concat(str));
        notifyResponseHandlers(responseArrFetch);
        Response response = responseArrFetch[responseArrFetch.length - 1];
        if (response.isOK()) {
    ...
    public BODY fetchSectionBody(int i, String str, String str2) throws ProtocolException {
    ...
    */
    public synchronized void idleStart() throws ProtocolException {
        ...
        while (!z) {
            try {
                ...
                responseByeResponse = Response.byeResponse(e3);
            }
            responseByeResponse = readResponse();
            arrayList.add(responseByeResponse);
            if (!responseByeResponse.isContinuation() && !responseByeResponse.isBYE()) {
            }
            z = true;
            while (!z) {
            }
    ...
    public int[] uidfetchChangedSince(long j, long j2, long j3) throws ProtocolException {
        ...
        sb.append(":");
        sb.append(j2 == -1 ? Marker.ANY_MARKER : String.valueOf(j2));
        StringBuilder sbQ = AbstractC4671xI0.q("UID FETCH ", sb.toString(), " (FLAGS) (CHANGEDSINCE ");
        sbQ.append(String.valueOf(j3));
        sbQ.append(")");
        Response[] responseArrCommand = command(sbQ.toString(), null);
        ArrayList arrayList = new ArrayList();
    ...
    public BODY fetchBody(int i, String str, boolean z) throws ProtocolException {
        if (str == null) {
            str = "";
        }
        StringBuilder sb = new StringBuilder();
    ...
    private Response[] fetch(String str, String str2, boolean z) throws ProtocolException {
        if (z) {
            return command(AbstractC4671xI0.k("UID FETCH ", str, " (", str2, ")"), null);
        }
        return command(AbstractC4671xI0.k("FETCH ", str, " (", str2, ")"), null);
    }

    private void storeFlags(String str, Flags flags, boolean z) throws ProtocolException {
        Response[] responseArrCommand;
        if (z) {
            StringBuilder sbQ = AbstractC4671xI0.q("STORE ", str, " +FLAGS ");
            sbQ.append(createFlagList(flags));
            responseArrCommand = command(sbQ.toString(), null);
        } else {
            StringBuilder sbQ2 = AbstractC4671xI0.q("STORE ", str, " -FLAGS ");
            sbQ2.append(createFlagList(flags));
            responseArrCommand = command(sbQ2.toString(), null);
        }
        notifyResponseHandlers(responseArrCommand);
        handleResult(responseArrCommand[responseArrCommand.length - 1]);
    }
