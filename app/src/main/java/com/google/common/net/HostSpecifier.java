...
public final class HostSpecifier {
    ...
    public static HostSpecifier from(String str) throws ParseException {
        try {
            ...
            ParseException parseException = new ParseException(AbstractC4671xI0.y("Invalid host specifier: ", str), 0);
    ...
    public static HostSpecifier fromValid(String str) {
        ...
        throw new IllegalArgumentException(AbstractC4671xI0.y("Domain name does not have a recognized public suffix: ", host));
    }
