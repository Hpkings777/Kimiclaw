...
public final class Encoder {
    ...
    public static BitArray interleaveWithECBytes(BitArray bitArray, int i, int i2, int i3) throws WriterException {
        ...
        StringBuilder sbR = AbstractC2039eV.r(i10, "Interleaving error: ", " and ");
        sbR.append(bitArray2.getSizeInBytes());
        sbR.append(" differ.");
        throw new WriterException(sbR.toString());
    }
    ...
    */
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        if (map != null) {
            ...
            z = map.containsKey(encodeHintType) && Boolean.parseBoolean(map.get(encodeHintType).toString());
        }
        if (map != null) {
            EncodeHintType encodeHintType2 = EncodeHintType.QR_COMPACT;
            z2 = map.containsKey(encodeHintType2) && Boolean.parseBoolean(map.get(encodeHintType2).toString());
        }
