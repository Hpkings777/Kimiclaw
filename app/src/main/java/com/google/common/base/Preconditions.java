...
public final class Preconditions {
    ...
    private static String badElementIndex(int i, int i2, String str) {
        ...
        throw new IllegalArgumentException(YI0.h(i2, "negative size: "));
    }
    ...
    public static void checkArgument(boolean z, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(Platform.stringValueOf(obj));
        }
    }
    ...
    public static <T> T checkNotNull(T t, Object obj) {
        ...
        throw new NullPointerException(Platform.stringValueOf(obj));
    }
    ...
    public static void checkState(boolean z, Object obj) {
        if (!z) {
            throw new IllegalStateException(Platform.stringValueOf(obj));
        }
    }

    public static void checkArgument(boolean z, String str, Object... objArr) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, objArr));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object... objArr) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, objArr));
    }

    public static void checkState(boolean z, String str, Object... objArr) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, objArr));
        }
    }
    ...
    public static void checkArgument(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj));
    }

    public static void checkState(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj));
        }
    }
    ...
    public static void checkArgument(boolean z, String str, char c, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, Character.valueOf(c), obj));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, char c, Object obj) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, Character.valueOf(c), obj));
    }

    public static void checkState(boolean z, String str, char c, Object obj) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, Character.valueOf(c), obj));
        }
    }
    ...
    public static void checkArgument(boolean z, String str, int i, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, Integer.valueOf(i), obj));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, int i, Object obj) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, Integer.valueOf(i), obj));
    }

    public static void checkState(boolean z, String str, int i, Object obj) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, Integer.valueOf(i), obj));
        }
    }
    ...
    public static void checkArgument(boolean z, String str, long j, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, Long.valueOf(j), obj));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, long j, Object obj) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, Long.valueOf(j), obj));
    }

    public static void checkState(boolean z, String str, long j, Object obj) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, Long.valueOf(j), obj));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, char c) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, Character.valueOf(c)));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, char c) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, Character.valueOf(c)));
    }

    public static void checkState(boolean z, String str, Object obj, char c) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, Character.valueOf(c)));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, int i) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, Integer.valueOf(i)));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, int i) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, Integer.valueOf(i)));
    }

    public static void checkState(boolean z, String str, Object obj, int i) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, Integer.valueOf(i)));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, long j) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, Long.valueOf(j)));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, long j) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, Long.valueOf(j)));
    }

    public static void checkState(boolean z, String str, Object obj, long j) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, Long.valueOf(j)));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, Object obj2) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, obj2));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, Object obj2) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, obj2));
    }

    public static void checkState(boolean z, String str, Object obj, Object obj2) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, obj2));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, Object obj2, Object obj3) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, obj2, obj3));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, Object obj2, Object obj3) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, obj2, obj3));
    }

    public static void checkState(boolean z, String str, Object obj, Object obj2, Object obj3) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, obj2, obj3));
        }
    }

    public static void checkArgument(boolean z, String str, Object obj, Object obj2, Object obj3, Object obj4) {
        if (!z) {
            throw new IllegalArgumentException(Platform.lenientFormat(str, obj, obj2, obj3, obj4));
        }
    }
    ...
    public static <T> T checkNotNull(T t, String str, Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        throw new NullPointerException(Platform.lenientFormat(str, obj, obj2, obj3, obj4));
    }

    public static void checkState(boolean z, String str, Object obj, Object obj2, Object obj3, Object obj4) {
        if (!z) {
            throw new IllegalStateException(Platform.lenientFormat(str, obj, obj2, obj3, obj4));
        }
    }
}
