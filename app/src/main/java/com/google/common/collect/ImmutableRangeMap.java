...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    @Override // com.google.common.collect.RangeMap
    public V get(K k) {
        int iBinarySearch = SortedLists.binarySearch(this.ranges, new C2768ji(10), Cut.belowValue(k), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        C2768ji c2768ji = new C2768ji(9);
        Comparable comparable = range.lowerBound;
        SortedLists.KeyPresentBehavior keyPresentBehavior = SortedLists.KeyPresentBehavior.FIRST_AFTER;
        SortedLists.KeyAbsentBehavior keyAbsentBehavior = SortedLists.KeyAbsentBehavior.NEXT_HIGHER;
        final int iBinarySearch = SortedLists.binarySearch(immutableList, c2768ji, comparable, keyPresentBehavior, keyAbsentBehavior);
        int iBinarySearch2 = SortedLists.binarySearch(this.ranges, new C2768ji(10), range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, keyAbsentBehavior);
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>(this) { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public Range<K> get(int i2) {
                ...
                return (i2 == 0 || i2 == i + (-1)) ? ((Range) this.this$0.ranges.get(i2 + iBinarySearch)).intersection(range) : (Range) this.this$0.ranges.get(i2 + iBinarySearch);
            }
