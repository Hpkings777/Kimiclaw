...
public final class ImmutableLongArray implements Serializable {
    ...
    public static final class AsList extends AbstractList<Long> implements RandomAccess, Serializable {
    ...
    public int hashCode() {
        int iHashCode = 1;
        for (int i = this.start; i < this.end; i++) {
            iHashCode = (iHashCode * 31) + Long.hashCode(this.array[i]);
        }
        return iHashCode;
    }
    ...
    public static final class Builder {
        ...
        /* JADX WARN: Type inference failed for: r5v1, types: [java.util.Spliterator, java.util.Spliterator$OfLong] */
        @IgnoreJRERequirement
        public Builder addAll(LongStream longStream) {
            ...
            Spliterator.forEachRemaining(new LongConsumer() { // from class: tW
