    ...
    private void implCompress(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i3 >= iArr.length) {
                ...
                int iFF4 = FF(i5, iFF3, iFF2, iFF, this.x[3], S14);
                ...
                int iFF8 = FF(iFF4, iFF7, iFF6, iFF5, this.x[7], S14);
                ...
                int iFF12 = FF(iFF8, iFF11, iFF10, iFF9, this.x[11], S14);
                int iFF13 = FF(iFF9, iFF12, iFF11, iFF10, this.x[12], 3);
                int iFF14 = FF(iFF10, iFF13, iFF12, iFF11, this.x[S24], 7);
                int iFF15 = FF(iFF11, iFF14, iFF13, iFF12, this.x[14], 11);
                int iFF16 = FF(iFF12, iFF15, iFF14, iFF13, this.x[S34], S14);
                ...
                int iGG4 = GG(iFF16, iGG3, iGG2, iGG, this.x[12], S24);
                ...
                int iGG8 = GG(iGG4, iGG7, iGG6, iGG5, this.x[S24], S24);
                ...
                int iGG12 = GG(iGG8, iGG11, iGG10, iGG9, this.x[14], S24);
                ...
                int iGG16 = GG(iGG12, iGG15, iGG14, iGG13, this.x[S34], S24);
                ...
                int iHH4 = HH(iGG16, iHH3, iHH2, iHH, this.x[12], S34);
                ...
                int iHH8 = HH(iHH4, iHH7, iHH6, iHH5, this.x[14], S34);
                ...
                int iHH12 = HH(iHH8, iHH11, iHH10, iHH9, this.x[S24], S34);
                ...
                int iHH16 = HH(iHH12, iHH15, iHH14, iHH13, this.x[S34], S34);
            ...
            iArr[i3] = (bArr[i2] & UnsignedBytes.MAX_VALUE) | ((bArr[i2 + 1] & UnsignedBytes.MAX_VALUE) << 8) | ((bArr[i2 + 2] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[i2 + 3] & UnsignedBytes.MAX_VALUE) << 24);
            i2 += 4;
            i3++;
        }
    }
