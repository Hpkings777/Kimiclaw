                ...
                if (cCharAt >= ' ') {
                    ...
                    if (line.length() >= (((i * 8) + 5) / 6) + 1) {
                        ...
                        while (this.bufsize < i) {
                            ...
                            int i3 = i2 + 2;
                            byte bCharAt2 = (byte) ((line.charAt(i2 + 1) - ' ') & 63);
                            byte[] bArr = this.buffer;
                            int i4 = this.bufsize;
                            int i5 = i4 + 1;
                            this.bufsize = i5;
                            bArr[i4] = (byte) (((bCharAt << 2) & 252) | ((bCharAt2 >>> 4) & 3));
                            if (i5 < i) {
                                i2 += 3;
                                byte bCharAt3 = (byte) ((line.charAt(i3) - ' ') & 63);
                                byte[] bArr2 = this.buffer;
                                int i6 = this.bufsize;
                                this.bufsize = i6 + 1;
                                bArr2[i6] = (byte) (((bCharAt2 << 4) & 240) | ((bCharAt3 >>> 2) & 15));
                                bCharAt2 = bCharAt3;
                            } else {
                                i2 = i3;
                            }
                            if (this.bufsize < i) {
                                ...
                                int i8 = this.bufsize;
                                this.bufsize = i8 + 1;
                                bArr3[i8] = (byte) ((bCharAt4 & 63) | ((bCharAt2 << 6) & 192));
                                i2 = i7;
                            }
                        }
                        return true;
