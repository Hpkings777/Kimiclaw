...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length > 80) {
            throw new IllegalArgumentException(YI0.h(length, "Requested contents should be less than 80 digits long after converting to extended encoding, but got "));
        }
        ...
        StringBuilder sbT = AbstractC2039eV.t(strConvertToExtended);
        sbT.append("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(iComputeChecksumIndex));
        int iAppendPattern3 = iAppendPattern2 + appendPattern(zArr, iAppendPattern2, iArr[computeChecksumIndex(sbT.toString(), 15)]);
