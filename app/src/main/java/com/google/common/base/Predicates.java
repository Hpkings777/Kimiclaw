...
public final class Predicates {
    ...
    public static final class ContainsPatternFromStringPredicate extends ContainsPatternPredicate {
        ...
        public String toString() {
            return AbstractC4671xI0.p(new StringBuilder("Predicates.containsPattern("), this.pattern.pattern(), ")");
        }
    }
    ...
    public static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ContainsPatternPredicate) {
                ...
                if (java.util.Objects.equals(this.pattern.pattern(), containsPatternPredicate.pattern.pattern()) && this.pattern.flags() == containsPatternPredicate.pattern.flags()) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return java.util.Objects.hash(this.pattern.pattern(), Integer.valueOf(this.pattern.flags()));
        }

        public String toString() {
            return AbstractC4671xI0.z("Predicates.contains(", MoreObjects.toStringHelper(this.pattern).add("pattern", this.pattern.pattern()).add("pattern.flags", this.pattern.flags()).toString(), ")");
        }
