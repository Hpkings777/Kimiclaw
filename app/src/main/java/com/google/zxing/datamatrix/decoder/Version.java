...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        int i9 = 2;
        Version version15 = new Version(15, 52, 52, 24, 24, new ECBlocks(i6, new ECB(i9, 102)));
        ...
        int i11 = 6;
        Version version21 = new Version(21, 104, 104, 24, 24, new ECBlocks(i7, new ECB(i11, 136)));
        ...
        Version version24 = new Version(24, 144, 144, 22, 22, new ECBlocks(62, new ECB(8, 156), new ECB(i9, 155)));
        int i12 = 1;
        ...
        int i16 = 1;
        Version version32 = new Version(32, 8, 64, 6, 14, new ECBlocks(18, new ECB(i16, 24)));
        Version version33 = new Version(33, 8, 80, 6, 18, new ECBlocks(22, new ECB(i16, i14)));
        int i17 = 38;
        int i18 = 1;
        return new Version[]{version, version2, version3, version4, version5, version6, version7, version8, version9, version10, version11, version12, version13, version14, version15, version16, version17, version18, version19, version20, version21, version22, version23, version24, version25, version26, version27, version28, version29, version30, version31, version32, version33, new Version(34, 8, 96, 6, 22, new ECBlocks(28, new ECB(1, i17))), new Version(35, 8, 120, 6, 18, new ECBlocks(i14, new ECB(1, 49))), new Version(36, 8, 144, 6, 22, new ECBlocks(i5, new ECB(1, 63))), new Version(37, 12, 64, 10, 14, new ECBlocks(27, new ECB(1, 43))), new Version(38, 12, 88, 10, 20, new ECBlocks(i5, new ECB(i18, 64))), new Version(39, 16, 64, 14, 14, new ECBlocks(i5, new ECB(i18, 62))), new Version(40, 20, 36, 18, 16, new ECBlocks(28, new ECB(i18, 44))), new Version(41, 20, 44, 18, 20, new ECBlocks(34, new ECB(i18, i7))), new Version(42, 20, 64, 18, 14, new ECBlocks(42, new ECB(1, 84))), new Version(43, 22, 48, 20, 22, new ECBlocks(i17, new ECB(1, 72))), new Version(44, 24, 48, 22, 22, new ECBlocks(41, new ECB(1, 80))), new Version(45, 24, 64, 22, 14, new ECBlocks(46, new ECB(1, 108))), new Version(46, 26, 40, 24, 18, new ECBlocks(i17, new ECB(1, 70))), new Version(47, 26, 48, 24, 22, new ECBlocks(42, new ECB(1, 90))), new Version(48, 26, 64, 24, 14, new ECBlocks(50, new ECB(1, 118)))};
    }
